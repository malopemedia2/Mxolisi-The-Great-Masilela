      ...
      <div className="relative max-w-7xl mx-auto px-6 py-16 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_0.8fr] items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-xl md:text-2xl text-gray-200">A South African theatre-maker, cultural entrepreneur and community leader who has anchored independent township storytelling from Tembisa to the world stage.</p>
    ...
    <div className="min-h-screen bg-[#090909] text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-12">
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">Born in the Madelakufa informal settlement in Tembisa, Ekurhuleni, Gauteng, Mxolisi grew up facing significant challenges, including an absent father and poverty that shaped his early years.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">At age nine, theatre entered his life when he secretly joined the Rutanang Community Theatre Project, later known as Sizimele Art Foundation, marking the beginning of his artistic journey.</p>
        </section>
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle">Education & Training</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">After Grade 12, Mxolisi trained formally at Windybrow Theatre's performing arts program, where he honed his skills in performance, direction and theatrical production.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">He also gained international exposure through training or residencies linked to NIDA in Australia around 2018. He has served as a visiting artist and facilitator across multiple platforms.</p>
        </section>
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle">Artistic Philosophy & Impact</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">Mxolisi views theatre as a mirror to the community, a tool for activism, healing, awareness, and social change. He addresses teenage pregnancy, violence, identity and resilience through his work.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">He believes community theatre artists are "servants of God" chosen to serve and heal. Storytelling connects, inspires, provokes, and amplifies voices that mainstream platforms often ignore.</p>
        </section>
      </main>
    </div>
  )
    ...
    <div className="min-h-screen bg-[#090909] text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-10">
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">In Grade 10, I wrote and directed my first play, Dropping in the Heart, about the clash between parental expectations and a child's true calling. The response was overwhelming.</p>
          ...
          <p className="mt-4 text-gray-300 leading-relaxed">I am a husband and a father. I have a daughter who is my greatest motivation and responsibility. In reflections on fatherhood and absent fathers, I honour both the pain and the possibility of healing.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">My marriage and family life are sacred; I speak often about love, commitment, and brotherhood in podcasts and dialogues, including heartfelt conversations on fatherhood and male identity.</p>
        </section>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-4 text-gray-300 leading-relaxed">Then came deeper works: Insanity, Exhibition (men's emotions), Medumo ya Borwa (Ovation recognition), Walls & Pillows, These Are Not My Shoes, LEINA, Behind Van Vuuren's Farm and Malepa The Musical.</p>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">In 2008, at age 17, I founded TX Theatre Productions. The physical dream became reality with The TX Theatre — a 100-seater hub near Moses Molelekwa Community Centre in Tembisa.</p>
          ...
          <p className="mt-4 text-gray-300 leading-relaxed">Through it, I lead Tembisa Theatre Week (10th edition in 2026), Kuwamba National Women's Theatre Festival, training programmes, awards, and community development initiatives.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">The Writers' Lab – Nurturing New Voices</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">The Writers' Lab (or Writers Lab SA / Pretoria) is a vital partner and extension of our work at TX Theatre. Together, we run workshops, script development and advocacy for emerging playwrights.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">We publish anthologies like "A Gathering of Stories" (launched with readings at TX Theatre and Johannesburg), which includes my play Uncharted Territories and other works celebrating township voices.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Brothers, Collaborators, and Friends</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">Theatre is family. My long-time partner and business collaborator is Mongezi Mabunda — we've built so much together. Close creatives include Tshwarelo Selolo, Gifter Ngobeni, Sfiso Botha and many others.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">Dialogues with Masai Sepuru on love, marriage, fatherhood, and art have been profound. The TX family — from emerging artists to veterans — continues to grow and create magic together.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Recognition and Ongoing Journey</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">I am a 2025 ISPA Global Fellow, featured in Mail & Guardian's 200 Young South Africans, multiple Naledi Award recipient (productions and individual nominations), and recognized across theatre networks.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">I continue writing new plays (including one about prayer and men kneeling), curating festivals, advocating for funding and transport support for township artists.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">I am a philanthropist, facilitator, curator, producer, and entrepreneur in the arts. I believe artists are servants chosen to heal, provoke, connect and amplify.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">My daughter, my wife, my family, my brothers in the arts, and the communities we serve keep me grounded. I refuse to pass on unbroken cycles of pain.</p>
    ...
    <div className="min-h-screen bg-[#090909] text-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-28">
          ...
          <p className="mt-6 max-w-3xl text-gray-200">Tembisa Theatre Week is an annual celebration of independent theatre makers, new plays and community creativity. It brings together emerging and established artists to premiere original work.</p>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-10">
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">Founded around 2017, the first edition of Tembisa Theatre Week ran from 21–29 January 2017 with 13 new theatre productions premiering. By 2026, it had grown to its 10th milestone edition.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">Mxolisi describes the festival as a collective artistic vision rooted in community, bridging township creativity with broader recognition while maintaining grassroots integrity.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Purpose and Impact</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">The festival showcases new and original productions, often around 10 plays per edition, alongside dance, music and interdisciplinary works. It nurtures emerging voices and celebrates established township creators.</p>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">The festival typically runs for about a week in January or February at The TX Theatre in the Moses Molelekwa Community Centre area. It includes performances, workshops, panel discussions and networking sessions.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">Many productions from Tembisa Theatre Week go on to further recognition, touring to places like Market Theatre, the National Arts Festival, Joburg Theatre and international venues.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Recent Editions</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">The 10th edition in 2026 was a major milestone celebration with open calls for 10 new productions and strong sponsorship support. The 2025 edition continued the festival's tradition of discovery and celebration.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">This festival complements other TX Theatre initiatives, including the Kuwamba National Women's Theatre Festival, and forms part of Mxolski's broader vision for township cultural leadership.</p>
        </section>
      </main>
    </div>
  )
    ...
    <div className="min-h-screen bg-[#090909] text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-10">
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">Names are presented as carriers of spirituality, legacy, ritual and ancestral memory. The piece explores reincarnation through names, linking the living to the ancestors.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">It draws on African ritual performance, music and prayer, influenced by Mxolski's NIDA training on Ritual as Performance, creating a rich, immersive spiritual experience.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Production Details</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">Writer & Director: Mxolski "The Great" Masilela. Production Manager: Precious Mashishi. Lighting & Sound Design: Sizwe Ndabane.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">Key cast includes Tswarelo "Ntate" Selolo, Gifter Ngobeni, Mongezi Mabunda, and others. Musicians and choir members include Amanda Khuma, Lerato Nthokazi and ensemble performers.</p>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">LEINA received four nominations at the 2024 Naledi Theatre Awards: Best Production of a Play, Lead Actor Male, Supporting Actor Male, and Ensemble Performance.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">The production reinforces Mxolski's philosophy of theatre as holy ground for healing, cultural reconnection and amplifying township voices in national and international spaces.</p>
        </section>
    ...
    <div className="min-h-screen bg-[#090909] text-white">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-10">
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_0.7fr] items-start">
            <div>
              ...
              <p className="mt-6 text-gray-300 leading-relaxed">These Are Not My Shoes centers on two brothers, Themba and Xolani, whose father disappears from their lives. It explores the emotional and social consequences of paternal absence, masculinity and survival.</p>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          ...
          <p className="mt-6 text-gray-300 leading-relaxed">The play premiered at TX Theatre and has been staged strongly during Tembisa Theatre Week, Joburg Theatre, Artscape and festivals like Baxter Theatre Centre.</p>
          <p className="mt-4 text-gray-300 leading-relaxed">This piece remains one of Mxolski's most performed works, praised for its social commentary, realism and ensemble strength.</p>
        </section>

        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Awards and Recognition</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">These Are Not My Shoes earned a Naledi nomination for Best Independent/Fringe Theatre Production and has been praised for its heart-wrenching exploration of brotherhood and absent fathers.</p>
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_0.7fr] items-start">
            <div>
              ...
              <p className="mt-6 text-gray-300 leading-relaxed">Malepa The Musical tells the story of a secret society in the north of South Africa. It celebrates authentic African spiritual traditions, ancestral connection and hidden wisdom passed through generations.</p>
              <p className="mt-4 text-gray-300 leading-relaxed">Malepa is a hidden village between mountains, inhabited by supernatural people who live by night and are visible only to those with a heart of gold or spiritual awakening.</p>
            </div>
            <div className="overflow-hidden rounded-3xl bg-[#111] shadow-xl">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 space-y-10">
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_0.7fr] items-start">
            <div>
              <h2 className="text-3xl font-playfair sparkle text-amber-300">Synopsis and Themes</h2>
              <p className="mt-6 text-gray-300 leading-relaxed">Set on the boundary of Limpopo, the play centers on Van Vuuren's farm — a malevolent playground where white power, land control and violence define daily life for a Black family struggling to survive and aspire.</p>
              <p className="mt-4 text-gray-300 leading-relaxed">The story follows a family whose hopes are crushed by oppression, with the mother holding fast to education and the possibility of freedom through knowledge and dignity.</p>
            </div>
            <div className="overflow-hidden rounded-3xl bg-[#111] shadow-xl">
        ...
        <section className="rounded-3xl bg-[#0f0f0f] p-10 shadow-xl shadow-black/40">
          <h2 className="text-3xl font-playfair sparkle text-amber-300">Significance</h2>
          <p className="mt-6 text-gray-300 leading-relaxed">Behind Van Vuuren's Farm is an unflinching cry against ongoing violence, systemic oppression and the silence around farmworker suffering. It demands justice, memory and transformation.</p>
        </section>
      </main>
    </div>
  )
  ...
  return (
    <div className="bg-[#090909] text-white">
      ...
      <Section id="autobio" className="bg-[#0b0b0b] rounded-3xl shadow-xl shadow-black/40">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_0.7fr] items-center">
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 shadow-xl">
            <img src="https://res.cloudinary.com/doaj3nv5i/image/upload/v1781133877/lhzkgp82n7tmgyf6r9vu.jpg" alt="Mxolski The Great Masilela" className="w-full h-full object-cover" />
          </div>
        </div>
      </Section>
      ...
      <Section id="hub">
        ...
        <p className="mt-4 text-gray-300 max-w-3xl">Founded around 2008, TX Theatre in Tembisa is a 100-seater rehearsal, workshop, festival and development hub staging 50+ shows annually. The venue serves as home to emerging and established township theatre makers.</p>
      ...
      <Section id="productions" className="bg-[#0b0b0b] rounded-3xl shadow-xl shadow-black/40">
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-2">
          <button type="button" onClick={() => setPage('leina')} className="group overflow-hidden rounded-3xl border border-white/10 bg-[#111] text-left shadow-xl transition duration-300 hover:-translate-y-2">
          ...
          <button type="button" onClick={() => setPage('shoes')} className="group overflow-hidden rounded-3xl border border-white/10 bg-[#111] text-left shadow-xl transition duration-300 hover:-translate-y-2">
          ...
          <button type="button" onClick={() => setPage('malepa')} className="group overflow-hidden rounded-3xl border border-white/10 bg-[#111] text-left shadow-xl transition duration-300 hover:-translate-y-2">
          ...
          <button type="button" onClick={() => setPage('vanvuuren')} className="group overflow-hidden rounded-3xl border border-white/10 bg-[#111] text-left shadow-xl transition duration-300 hover:-translate-y-2">
      ...
      <Section id="philosophy">
        ...
        <p className="mt-4 text-gray-300 max-w-3xl">He sees theatre as a mirror to the community and a tool for activism, healing, awareness, and social change. His work addresses teenage pregnancy, crime, identity, fatherhood and resilience.</p>
      </Section>
      ...
      <Section id="press" className="bg-[#0b0b0b] rounded-3xl shadow-xl shadow-black/40">
        ...
        <a href="https://mg.co.za/friday/2026-06-19-they-didn-t-wait-for-an-invitation-they-built-the-table-themselves/" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 text-amber-300 hover:text-white transition">
